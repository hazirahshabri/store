...
$sql ="SELECT studentName, studentID, phoneNo, address, faculty, gender from student WHERE studentID = '$matricNo' " ;  // SQL based on database declaration //letk condition  !!
