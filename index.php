              ...
              <table align="center" border="0" width="80%" cellpadding="7" cellspacing="0">
				...
				<td><form action="login.php" method="post">
                  <td width="35%" align="center"><h2><font color="#8B008B">LOGIN</font></h2>
                    Staff ID <input class="input" type="text" name="staffid" maxlength="5" autofocus required><br><br>
                    Password &nbsp;<input class="input" type="password" name="password" maxlength="20"required><br><br>
				...
				<td width="30%"><img src="Logo/UTeM.jpg" width="320px" height="290px"></td>
                  <td width="40%">
                    ...
                    <p> Welcome to our service! <br><br>
                       ...
                       If you are already become a user, you can login to the system. All you need is to insert your user id and password. <br><br>
					   This system can help you manage student to store their items. 
					   Make a booking for student to store their item during semester break. 
