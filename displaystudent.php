...
$sql ="SELECT studentName, studentID, phoneNo, address, postcode, state, faculty from student WHERE studentID = '$matricNo' " ; 
      ...
      <div class="main">
          ...
          <div class="Mcontent">
            ...
            <table align="center" border="0" width="70%" cellpadding="5" cellspacing="1">
              <td><hr></td>
              <td width="25%" align="center"><h2><p><img src="logo/list.png" alt="icon list" width="42" height="42" align="middle" hspace="20"><font color="#8B008B">Student Detail</font></h2></td>
              <td><hr></td>
            </table>
